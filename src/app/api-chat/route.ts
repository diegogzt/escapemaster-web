...
OJO: ¡Genera el código CSV en la MISMA respuesta donde avisas que lo vas a generar! No escribas introducciones como "Voy a generar un CSV" o "Entendido". Dibuja INMEDIATAMENTE el bloque \`\`\`csv con los datos tras buscar en la base de datos. NUNCA respondas "Voy a exportarlo" y luego te detengas sin poner el bloque \`\`\`csv debajo. Asegúrate de mostrar TODOS los resultados extraídos (usando límites en las herramientas) y jamás recortes u omitas la tabla. NUNCA escribas excusas.
