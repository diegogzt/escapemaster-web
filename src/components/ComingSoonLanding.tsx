...
const ComingSoonLanding = () => {
  ...
  return (
    <div ref={containerRef} className="theme-tropical bg-dark text-light selection:bg-secondary/30">
      {/* Background Elements - Tropical Theme */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="parallax-bg absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-primary/20 rounded-full blur-[120px]" />
        <div className="parallax-bg absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-accent/10 rounded-full blur-[120px]" />
        <div className="parallax-bg absolute top-[20%] right-[15%] w-[20%] h-[20%] bg-secondary/10 blur-[80px] rounded-full" />
      </div>
      ...
      <section ref={heroRef} className="relative min-h-screen flex flex-col items-center justify-center px-6 overflow-hidden">
        <div ref={floatingRef} className="absolute inset-0 pointer-events-none">
          <div className="absolute top-[20%] left-[15%] w-12 h-12 border border-secondary/20 rounded-lg rotate-12" />
          <div className="absolute top-[60%] left-[10%] w-8 h-8 bg-accent/20 rounded-full blur-sm" />
          <div className="absolute top-[30%] right-[15%] w-16 h-16 border border-secondary/20 rounded-full" />
        ...
        <div className="z-10 text-center max-w-4xl">
          ...
          <h1 className="hero-title text-4xl md:text-7xl font-bold tracking-tighter mb-8 bg-clip-text text-transparent bg-linear-to-b from-white to-secondary/50">
            ESCAPEMASTER
          </h1>
          
          <p className="hero-description text-xl md:text-2xl text-light/60 font-light leading-relaxed mb-12 max-w-2xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
            <div className="max-w-2xl">
              ...
              <p className="animate-on-scroll text-lg text-light/60 max-w-xl font-light">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={i}
                className="feature-card group relative p-10 rounded-[2.5rem] border border-white/5 bg-dark hover:bg-primary/10 transition-all duration-500 overflow-hidden shadow-2xl"
              >
                <div className="absolute top-0 right-0 w-32 h-32 bg-linear-to-br from-white/5 to-transparent rounded-bl-[5rem] -mr-10 -mt-10 transition-transform duration-700 group-hover:scale-110" />
                
                <div className="relative z-10">
                  <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-8 transition-all duration-500 group-hover:scale-110 group-hover:rotate-3 shadow-lg ${feature.accentClass}`}>
                    {feature.icon}
                  </div>
                  <h3 className="text-2xl font-bold mb-4 text-white group-hover:text-secondary transition-colors">
                    {feature.title}
                  </h3>
                  <p className="text-light/50 leading-relaxed text-lg font-light group-hover:text-light/80 transition-colors">
                    {feature.desc}
                  </p>
                </div>
      ...
      <section ref={customizationRef} className="relative py-32 px-6 z-10 bg-primary/5">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="animate-on-scroll">
            <h2 className="text-4xl md:text-7xl font-bold mb-8 tracking-tight">Tu marca, <br />tus reglas</h2>
            <p className="text-light/60 text-xl mb-12 leading-relaxed font-light">
            ...
            <ul className="space-y-6">
              {[
                ...
                <li key={i} className="flex items-center gap-4 text-lg text-light/80">
          ...
          <div className="animate-on-scroll relative aspect-square rounded-[3rem] overflow-hidden border border-white/5 bg-dark flex items-center justify-center group shadow-2xl">
            <div className="absolute inset-0 bg-linear-to-br from-secondary/10 to-transparent opacity-50 group-hover:opacity-100 transition-opacity duration-700" />
            <Palette size={120} className="text-secondary/10 group-hover:scale-110 transition-transform duration-700" />
            <div className="relative z-10 p-8 w-full">
              <div className="bg-dark/80 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-2xl transform group-hover:-translate-y-2 transition-transform duration-500">
                ...
                <div className="space-y-4">
                  <div className="h-4 w-3/4 bg-secondary/20 rounded-full" />
                  <div className="h-4 w-1/2 bg-secondary/10 rounded-full" />
                  <div className="h-40 w-full bg-secondary/5 rounded-2xl border border-white/5 mt-6 flex items-center justify-center">
      ...
      <section ref={mobileRef} className="relative py-32 px-6 z-10 overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="animate-on-scroll order-2 lg:order-1 relative">
            <div className="parallax-bg absolute -top-20 -left-20 w-64 h-64 bg-secondary/10 rounded-full blur-3xl" />
            <div className="relative z-10 flex justify-center lg:justify-start gap-8">
              {/* Mockup representation */}
              <div className="w-64 h-[500px] bg-dark rounded-[3rem] border-8 border-primary shadow-2xl overflow-hidden relative group">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-6 bg-primary rounded-b-2xl z-20" />
                <div className="absolute inset-0 bg-linear-to-b from-primary/40 to-black p-6 pt-12">
                  <div className="w-10 h-10 bg-secondary rounded-lg mb-6 animate-pulse" />
                  <div className="space-y-4">
                    <div className="h-4 w-full bg-white/10 rounded-full" />
                    <div className="h-4 w-2/3 bg-white/10 rounded-full" />
                    <div className="h-32 w-full bg-secondary/20 rounded-2xl border border-white/10 flex items-center justify-center">
                      <BarChart3 className="text-secondary/40 w-12 h-12" />
                    </div>
                    <div className="h-32 w-full bg-white/5 rounded-2xl" />
                  </div>
                </div>
              </div>
              <div className="hidden md:block w-64 h-[500px] bg-dark rounded-[3rem] border-8 border-primary shadow-2xl overflow-hidden relative mt-12 group">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-6 bg-primary rounded-b-2xl z-20" />
                <div className="absolute inset-0 bg-linear-to-b from-accent/20 to-black p-6 pt-12">
                  <div className="w-10 h-10 bg-accent rounded-lg mb-6" />
                  <div className="space-y-4">
                    <div className="h-4 w-full bg-white/10 rounded-full" />
                    <div className="h-4 w-2/3 bg-white/10 rounded-full" />
                    <div className="h-48 w-full bg-accent/10 rounded-2xl border border-white/10 flex items-center justify-center">
                      <Users className="text-accent/40 w-16 h-16" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="animate-on-scroll order-1 lg:order-2">
            ...
            <h2 className="text-4xl md:text-7xl font-bold mb-8 tracking-tight">Tu negocio <br />en tu bolsillo</h2>
            <p className="text-light/60 text-xl mb-10 leading-relaxed font-light">
            ...
            <div className="flex flex-wrap gap-4">
              <div className="px-8 py-4 rounded-2xl bg-white/5 border border-white/10 flex items-center gap-4 grayscale opacity-50 hover:opacity-100 hover:grayscale-0 transition-all duration-500 cursor-not-allowed">
                <div className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center">
                  <span className="text-xl"></span>
                </div>
                <div className="text-left">
                  <p className="text-[10px] uppercase tracking-widest text-zinc-500 font-bold">Disponible en</p>
      ...
      <section ref={waitlistRef} className="relative py-32 px-6 z-10">
        <div className="max-w-3xl mx-auto text-center">
          <div className="animate-on-scroll">
            ...
            <p className="text-light/60 text-xl mb-12 font-light">
            ...
            {submitted ? (
              <div className="p-10 rounded-[2.5rem] bg-secondary/10 border border-secondary/30 text-secondary shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4 p-2 rounded-[3rem] bg-white/5 border border-white/10 backdrop-blur-sm">
                <input
                  type="email"
                  required
                  ...
                  className="flex-1 px-8 py-4 rounded-full bg-transparent focus:outline-none text-lg"
                />
                <button 
                  type="submit"
                  className="px-10 py-4 bg-secondary text-dark font-bold rounded-full hover:bg-accent hover:text-dark transition-all duration-300 shadow-lg"
                >
                  Apuntarme
                </button>
              </form>
            ...
            <p className="mt-8 text-light/30 text-sm">
              Al suscribirte, aceptas nuestra <Link href="/privacy" className="underline hover:text-secondary">Política de Privacidad</Link>.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="relative py-12 px-6 z-10 border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-8 text-light/40 text-sm">
